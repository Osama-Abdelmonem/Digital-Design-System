...
lappend search_path /home/IC/Projects/System/RTL/Premapped
...
read_file -format $file_format uart_fsm.v
...
read_file -format $file_format System_Top.v   # read the top the last one
...
set_input_delay $in_delay -clock $CLK_NAME [get_port CONTROL_EN]
...
set_output_delay $out_delay -clock $CLK_NAME [get_port SYS_OUT]
set_output_delay $out_delay -clock $CLK_NAME [get_port SYS_VLD]
...
set_driving_cell -library scmetro_tsmc_cl013g_rvt_ss_1p08v_125c -lib_cell BUFX2M -pin Y [get_port CONTROL_EN]
...
set_load 75 [get_port SYS_OUT]
set_load 75 [get_port SYS_VLD]
